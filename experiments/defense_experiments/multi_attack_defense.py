                ...
                for attacker in attackers:
                    ...
                    if result is not None:
                        ...
                        if result.perturbed_result.output != result.original_result.ground_truth_output and \
                            ...
                            augs = augmentor.single_augment(result.original_result.attacked_text.text,
                                                            result.original_result.ground_truth_output, 1)
                            if augs:
                                for aug in augs:
                                    infer_res = augmentor.text_classifier.infer(
                                        aug + '!ref!{}'.format(result.perturbed_result.ground_truth_output))
